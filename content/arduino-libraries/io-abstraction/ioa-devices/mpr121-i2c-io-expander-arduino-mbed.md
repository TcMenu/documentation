...
This device can even be used in conjunction with an [MPR121 analog device](${refdocs("/ioabstraction/html/class_m_p_r121_analog_abstraction.html")}) to make it even easier to use the LED controller.
