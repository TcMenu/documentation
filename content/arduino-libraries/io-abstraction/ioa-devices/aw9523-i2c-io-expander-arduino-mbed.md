...
This device can even be used in conjunction with an [AW9523 analog device](${refdocs("/ioabstraction/html/class_a_w9523_analog_abstraction.html")}) to make it even easier to use the LED controller.
