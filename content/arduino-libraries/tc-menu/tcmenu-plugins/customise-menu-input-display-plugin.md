...
Before trying to modify the class you should probably [read through the API documentation](${refdocs("/tcmenu/html/index.html")}), especially look at the documentation for the chosen render in detail. Never make changes to files inside tcMenu library, these will be overwritten in future updates.
